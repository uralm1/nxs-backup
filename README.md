...
- Full data backup
  ...
  - Database backups:
    ...
    - Physical backups by MariaDB-backup of MariaDB (10-12/_all versions_)
    - Logical backups of PostgreSQL (9-18/_all versions_)
    - Physical backups by Basebackups of PostgreSQL (9-18/_all versions_)
    - Backups of MongoDB (4.0-8.0/_all versions_)
