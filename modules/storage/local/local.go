...
func (l *Local) DeliverBackup(logCh chan logger.LogRecord, jobName, tmpBackupFile, ofs string) (err error) {
	backupDstPath, links, err :=
		GetBackupDstAndLinks(tmpBackupFile, ofs, l.backupPath, l.Retention)
	if err != nil {
