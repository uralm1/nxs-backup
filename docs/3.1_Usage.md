...
# Each event in the log has a certain level: "error", "warning", "info", "debug", "trace". The minimum level of events for logging is defined here.
...
storage_connections: list # Default: []
