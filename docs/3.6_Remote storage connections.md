...
Example for connecting to AWS S3, in the storage_connects block of nxs-backup.yml.
```yaml
storage_connects:
- name: s3_aws
  s3_params:
...
Example for connecting to SFTP storage on 192.168.0.1 server, in the storage_connects block of nxs-backup.yml.
```yaml
storage_connects:
- name: scp_test
  scp_params:
...
Example for connecting to SMB storage on 192.168.0.1 server with share name `smb_share`, in the storage_connects block of nxs-backup.yml.
```yaml
storage_connects:
- name: smb_test
  smb_params:
...
Example for connecting to NFS storage on 192.168.0.1 server with backups/directory, in the storage_connects block of nxs-backup.yml.
```yaml
storage_connects:
- name: nfs_test
  nfs_params:
...
Example for connecting to FTPS storage on 192.168.0.1 server, in the storage_connects block of nxs-backup.yml.
```yaml
storage_connects:
- name: ftp_test
  ftp_params:
...
Example for connecting to WebDav storage on https://webdav.test.local, in the storage_connects block of nxs-backup.yml.
```yaml
storage_connects:
- name: webdav_test
  webdav_params:
